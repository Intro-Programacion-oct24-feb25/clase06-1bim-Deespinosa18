...
public class Ejemplo032 {
    ...
    public static void main(String[] args) {
        ...
        char valor = nombre.charAt(0); // obtener el primer caracter de una // cadena
        // utilizamos el nombre 2 como una variable auxiliar 
//apoyandonos del substring para luego 
//convertirlo en mayusculas al momento de imprimir y poder cumplir con el problema, 
//en cadena ponemos arango de 0-1 para obtener la primera letra                           
